  ...
  return (
    <div className='rounded-xl shadow-md relative'>
      ...
      <div className='p-4'>
        ...
        <h3 className='absolute top-[10px] right-[10px] bg-white px-4 py-2 rounded-lg text-[#573548] font-bold text-right md:text-center lg:text-right'>
          {getRateDisplay()}
        </h3>
        ...
        <div className='flex flex-col lg:flex-row justify-between mb-4'>
          ...
          <Link
            ...
            className='h-[36px] bg-[#573548] hover:bg-[#573548]/80 text-white px-4 py-2 rounded-lg text-center text-sm'
          >
            Details
          </Link>
        </div>
